		...
		<div className="flex flex-col items-center h-full relative">
			...
			<div className="flex flex-col items-center h-full relative gap-8 text-xl">
				<label>
					...
					<textarea value={data.goalName} name='name' cols="26" rows="1" className='p-2 resize-none border-slate-800 border rounded-md' placeholder='name example' onChange={(e) => setter.setGoalName(e.target.value)} />
				</label>

				<label className='flex flex-col'>
					<span>Description:</span>
					<textarea value={data.description} name='description' cols="26" rows="5" className='p-2 border-slate-800 border rounded-md' placeholder="Write your description here..." onChange={(e) => setter.setDescription(e.target.value)}/>
				</label>
			</div>
